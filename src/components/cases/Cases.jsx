          ...
          <div className="row">
            ...
            <MaterialTable
                ...
                columns={[
                  ...
                  lookup: {
                    'receive': '1.receive',
                    'contact_customer': '2.contact_customer',
                    'account_closing':'3.account_closing',
                    'transfer_doc_received':'4.ransfer_doc_received',
                    'transfer_doc_submitted':'5.transfer_doc_submitted',
                    'book_received':'6.book_received',
                    'submit_book_transfer':'7.submit_book_transfer',
                    'car_check_up':'8.car_check_up',
                    'book_transfer':'9.book_transfer',
                    'book_copy_received':'10.book_copy_received',
                    'deposit_doc_to_new_bank':'11.deposit_doc_to_new_bank',
                    'submit_book_deposit_return':'12.submit_book_deposit_return',
                    'book_received_back':'13.book_received_back',
                    'cash_received':'14.cash_received',
                    'book_deposit_received':'15.book_deposit_received',
                    'submit_book_to_new_finance':'16.submit_book_to_new_finance',
                   },
                  //  defaultGroupOrder: 0,
                   sorting: false 
                  },
