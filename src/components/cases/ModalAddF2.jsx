...
const ModalAddF2 = ({ singleCase, getAllCase , operatorS , getOperatorS}) => {
  ...
  const [newF2, setNewF2] = useState({
    ...
    book_closing_fee: singleCase.f2_book_closing_fee !== 0 ? singleCase.f2_book_closing_fee : 0,
    ...
    cartrust_other_fee: singleCase.f2_cartrust_other_fee ? singleCase.f2_cartrust_other_fee : 0,
    ...
    newfinance_other_fee: singleCase.f2_newfinance_other_fee ? singleCase.f2_newfinance_other_fee : 0,
  ...
  function saveF2() {
    ...
    let newData = {
      ...
      f2_status: "done",
      cheque: newF2.cheque?newF2.cheque:singleCase.f2_cheque?singleCase.f2_cheque:0,
      cheque_receiver: singleCase.name,
      deposit_receiver: singleCase.name,
      deposit: newF2.deposit?newF2.deposite:singleCase.f2_deposit?singleCase.f2_deposit:0,
