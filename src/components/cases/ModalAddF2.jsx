            ...
            columns: [
              ...
              },
              {
                ...
                stack: [
                  ...
                  {
                    text: appendString(old_finance_closing_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  },
                  {
                    ...
                    text: appendString(old_finance_transfer_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(book_closing_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(vat7_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(transfer_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(duty_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(cartrust_other_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(car_shield_fee_note),
                    fontSize: 12,
                    marginTop: 37,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(car_insurance_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(transfer_service_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(contract_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(outside_transfer_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
                  ...
                  {
                    text: appendString(newfinance_other_fee_note),
                    fontSize: 12,
                    marginTop: 8,
                    lineHeight:2,
